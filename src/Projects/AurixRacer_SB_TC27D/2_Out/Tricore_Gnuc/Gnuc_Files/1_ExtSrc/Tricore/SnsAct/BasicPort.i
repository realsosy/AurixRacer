...
void BasicPort_init(void)
{
    ...
    IfxPort_setPinMode(IfxPort_P33_0.port, IfxPort_P33_0.pinIndex, IfxPort_Mode_outputPushPullGeneral);
 IfxPort_setPinPadDriver(IfxPort_P33_0.port, IfxPort_P33_0.pinIndex, IfxPort_PadDriver_cmosAutomotiveSpeed1);
 setOutputPin(IfxPort_P33_0.port, IfxPort_P33_0.pinIndex, IR_Port.led0);

    IfxPort_setPinMode(IfxPort_P33_1.port, IfxPort_P33_1.pinIndex, IfxPort_Mode_outputPushPullGeneral);
 IfxPort_setPinPadDriver(IfxPort_P33_1.port, IfxPort_P33_1.pinIndex, IfxPort_PadDriver_cmosAutomotiveSpeed1);
 setOutputPin(IfxPort_P33_1.port, IfxPort_P33_1.pinIndex, IR_Port.led0);

    IfxPort_setPinMode(IfxPort_P33_2.port, IfxPort_P33_2.pinIndex, IfxPort_Mode_outputPushPullGeneral);
 IfxPort_setPinPadDriver(IfxPort_P33_2.port, IfxPort_P33_2.pinIndex, IfxPort_PadDriver_cmosAutomotiveSpeed1);
 setOutputPin(IfxPort_P33_2.port, IfxPort_P33_2.pinIndex, IR_Port.led0);


    IfxPort_setPinMode(IfxPort_P10_1.port, IfxPort_P10_1.pinIndex, IfxPort_Mode_outputPushPullGeneral);
 IfxPort_setPinPadDriver(IfxPort_P10_1.port, IfxPort_P10_1.pinIndex, IfxPort_PadDriver_cmosAutomotiveSpeed1);
 setOutputPin(IfxPort_P10_1.port, IfxPort_P10_1.pinIndex, IR_Port.m11_inh);

    IfxPort_setPinMode(IfxPort_P10_2.port, IfxPort_P10_2.pinIndex, IfxPort_Mode_outputPushPullGeneral);
 IfxPort_setPinPadDriver(IfxPort_P10_2.port, IfxPort_P10_2.pinIndex, IfxPort_PadDriver_cmosAutomotiveSpeed1);
 setOutputPin(IfxPort_P10_2.port, IfxPort_P10_2.pinIndex, IR_Port.m12_inh);
...
void BasicPort_run(void)
{
 ...
 setOutputPin(IfxPort_P33_0.port, IfxPort_P33_0.pinIndex, IR_Port.led0);
 setOutputPin(IfxPort_P33_1.port, IfxPort_P33_1.pinIndex, IR_Port.led1);
 setOutputPin(IfxPort_P33_2.port, IfxPort_P33_2.pinIndex, IR_Port.led2);


 setOutputPin(IfxPort_P10_1.port, IfxPort_P10_1.pinIndex, IR_MotorEn.Motor0Enable);
 setOutputPin(IfxPort_P10_2.port, IfxPort_P10_2.pinIndex, IR_MotorEn.Motor0Enable);
...
# 162 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/SnsAct/BasicPort.c"
