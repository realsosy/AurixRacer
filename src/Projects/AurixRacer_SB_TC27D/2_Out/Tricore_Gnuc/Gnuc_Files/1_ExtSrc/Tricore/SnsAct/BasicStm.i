...
static void BlinkLed_run(void)
{
    ...
    if (g_Stm.LedBlink == 1)
    {
        IfxPort_setPinState(IfxPort_P33_3.port, IfxPort_P33_3.pinIndex, IfxPort_State_high);
    }
    else
    {
        IfxPort_setPinState(IfxPort_P33_3.port, IfxPort_P33_3.pinIndex, IfxPort_State_low);
    }
...
static void BlinkLed_init(void)
{
    IfxPort_setPinMode(IfxPort_P33_3.port, IfxPort_P33_3.pinIndex, IfxPort_Mode_outputPushPullGeneral);
}
