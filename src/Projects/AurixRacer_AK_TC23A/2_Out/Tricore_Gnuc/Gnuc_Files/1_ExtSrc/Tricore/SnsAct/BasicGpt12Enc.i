...
# 114 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/SnsAct/BasicGpt12Enc.c"
    {
    ...
    (Ifx_Assert_doValidate(IfxGpt12_IncrEnc_init(&g_Gpt12Enc.incrEnc, &config), (2),"IfxGpt12_IncrEnc_init(&g_Gpt12Enc.incrEnc, &config)", "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/SnsAct/BasicGpt12Enc.c", 136, __func__));
}
...
# 165 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/SnsAct/BasicGpt12Enc.c"
typedef struct
{
    struct
    {
...
{
    g_EncEmul.control.run = 1;
    g_EncEmul.control.direction = IfxStdIf_Pos_Dir_forward;
    g_EncEmul.control.resolution = 32;
    g_EncEmul.control.step = 3;
    g_EncEmul.control.rawPosition = 0;
    g_EncEmul.control.speed = (3.1415926535897932384626433832795f) * 2.0;
...
void EncoderEmul_run(void)
{
    ...
    while (1)
    {
        ...
        {
            float32 roundDuration_s = (2.0 * (3.1415926535897932384626433832795f)) / g_EncEmul.control.speed;
            float32 tickDuration_s = roundDuration_s / (g_EncEmul.control.positionMask + 1);

            tickPeriod = tickDuration_s * (TimeConst[(8)]);
...
# 345 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/SnsAct/BasicGpt12Enc.c"
    }
}
