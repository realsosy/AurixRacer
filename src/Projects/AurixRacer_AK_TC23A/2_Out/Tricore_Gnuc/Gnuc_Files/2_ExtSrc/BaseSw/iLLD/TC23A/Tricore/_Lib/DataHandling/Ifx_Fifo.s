...
Ifx_Fifo_destroy:
.LFB282:
	.file 1 "../../_LibSrc/iLLD_1_0_1_8_0__TC23A/Src/BaseSw/iLLD/TC23A/Tricore/_Lib/DataHandling/Ifx_Fifo.c"
	.loc 1 69 0
.LVL0:
	.loc 1 70 0
	j	free
...
.LC1:
	.string	"../../_LibSrc/iLLD_1_0_1_8_0__TC23A/Src/BaseSw/iLLD/TC23A/Tricore/_Lib/DataHandling/Ifx_Fifo.c"
...
.LVL5:
	movh.a	%a5, hi:.LC1
	movh.a	%a6, hi:__func__.8794
	mov	%d4, 2
	lea	%a4, [%a4] lo:.LC0
	lea	%a5, [%a5] lo:.LC1
	mov	%d5, 79
.LVL6:
	lea	%a6, [%a6] lo:__func__.8794
...
.LVL11:
	...
	movh.a	%a4, hi:.LC2
	movh.a	%a5, hi:.LC1
	movh.a	%a6, hi:__func__.8784
	nez.a	%d4, %a2
	mov	%d5, 2
	lea	%a4, [%a4] lo:.LC2
	lea	%a5, [%a5] lo:.LC1
	mov	%d6, 59
	lea	%a6, [%a6] lo:__func__.8784
	.loc 1 57 0
	mov.aa	%a15, %a2
.LVL12:
	.loc 1 59 0
...
.LVL55:
	movh.a	%a5, hi:.LC1
	movh.a	%a6, hi:__func__.8807
	mov	%d4, 2
.LVL56:
	lea	%a4, [%a4] lo:.LC3
	lea	%a5, [%a5] lo:.LC1
	mov	%d5, 123
	lea	%a6, [%a6] lo:__func__.8807
	st.w	[%SP] 4, %d6
	st.w	[%SP]0, %d7
	call	Ifx_Assert_doLevel
.LVL57:
...
.LBE543:
	...
	movh.a	%a4, hi:.LC4
	movh.a	%a5, hi:.LC1
	movh.a	%a6, hi:__func__.8830
	mov	%d4, 2
	lea	%a4, [%a4] lo:.LC4
	lea	%a5, [%a5] lo:.LC1
	mov	%d5, 199
	lea	%a6, [%a6] lo:__func__.8830
	st.w	[%SP] 8, %d6
	st.w	[%SP] 4, %d7
	st.a	[%SP] 12, %a2
	call	Ifx_Assert_doLevel
...
.LVL165:
	movh.a	%a5, hi:.LC1
	movh.a	%a6, hi:__func__.8852
	mov	%d4, 2
.LVL166:
	lea	%a4, [%a4] lo:.LC3
	lea	%a5, [%a5] lo:.LC1
	mov	%d5, 281
	lea	%a6, [%a6] lo:__func__.8852
	st.w	[%SP] 4, %d6
	st.w	[%SP]0, %d7
	call	Ifx_Assert_doLevel
.LVL167:
...
.LBE787:
	...
	movh.a	%a4, hi:.LC4
	movh.a	%a5, hi:.LC1
	movh.a	%a6, hi:__func__.8874
	mov	%d4, 2
	lea	%a4, [%a4] lo:.LC4
	lea	%a5, [%a5] lo:.LC1
	mov	%d5, 353
	lea	%a6, [%a6] lo:__func__.8874
	st.w	[%SP] 8, %d6
	st.w	[%SP] 4, %d7
	st.a	[%SP] 12, %a2
	call	Ifx_Assert_doLevel
...
.section .rodata.__func__.8874,"a",@progbits
	...
	.size	__func__.8874, 15
__func__.8874:
	.string	"Ifx_Fifo_write"
.section .rodata.__func__.8852,"a",@progbits
	.type	__func__.8852, @object
	.size	__func__.8852, 23
__func__.8852:
	.string	"Ifx_Fifo_canWriteCount"
.section .rodata.__func__.8830,"a",@progbits
	.type	__func__.8830, @object
	.size	__func__.8830, 14
__func__.8830:
	.string	"Ifx_Fifo_read"
.section .rodata.__func__.8807,"a",@progbits
	.type	__func__.8807, @object
	.size	__func__.8807, 22
__func__.8807:
	.string	"Ifx_Fifo_canReadCount"
.section .rodata.__func__.8794,"a",@progbits
	.type	__func__.8794, @object
	.size	__func__.8794, 14
__func__.8794:
	.string	"Ifx_Fifo_init"
.section .rodata.__func__.8784,"a",@progbits
	.type	__func__.8784, @object
	.size	__func__.8784, 16
__func__.8784:
...
.Letext0:
	...
	.file 9 "../../_LibSrc/iLLD_1_0_1_8_0__TC23A/Src/BaseSw/iLLD/TC23A/Tricore/_Lib/DataHandling/Ifx_Fifo.h"
	...
	.file 15 "../../_LibSrc/iLLD_1_0_1_8_0__TC23A/Src/BaseSw/iLLD/TC23A/Tricore/_Lib/DataHandling/Ifx_CircularBuffer.h"
